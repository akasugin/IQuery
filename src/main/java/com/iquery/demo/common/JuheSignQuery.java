...
public class JuheSignQuery {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="dfa25df90a3e0c4d8206faf099860635";

    //1.运势查询
    public static void getRequest1(String consName,String type){
        String result =null;
