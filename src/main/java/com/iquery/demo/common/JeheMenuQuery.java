package com.iquery.demo.common;
...
public class JeheMenuQuery {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="a7eb2032ec589fe78bf343bca43b6240";

    //1.菜谱大全
    public static Object getRequest1(String name){
        String result = null;
...
//                System.out.println(object.get("result"));
                rt = object.get("result");
            }else{
//                System.out.println(object.get("error_code")+":"+object.get("reason"));
                rt = object.get("error_code")+":"+object.get("reason");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
